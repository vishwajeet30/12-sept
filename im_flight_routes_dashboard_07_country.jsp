...
<script>
	function myFunction(tagname,country_code_link)
	{
		...
		{
			window.open("im_flight_routes_dashboard_01_arr.jsp?tagname="+tagname+"&source_country="+country_code_link);
		}
		if(tagname == 'departure_country')
		{
			//modelWindow_download("im_flight_routes_dashboard_02_dep.jsp?tagname="+tagname,'_blank', '0.80');
			window.open("im_flight_routes_dashboard_02_dep.jsp?tagname="+tagname+"&dest_country="+country_code_link);
		}	
	}
