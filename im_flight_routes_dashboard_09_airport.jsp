...
<script>
	...
	function myFunction(tagname,port_Code_Link) 
	{
		...
		{
			window.open("http://192.168.62.201:8889/Imm/vishwajeet/im_flight_routes_dashboard_01_arr.jsp?tagname="+tagname+"&source_port="+port_Code_Link);
		}
		if(tagname == 'departure_country')
		{
			//modelWindow_download("im_flight_routes_dashboard_02_dep.jsp?tagname="+tagname,'_blank', '0.80');
			window.open("http://192.168.62.201:8889/Imm/vishwajeet/im_flight_routes_dashboard_02_dep.jsp?tagname="+tagname+"&dest_port="+port_Code_Link);
		}	
	}
